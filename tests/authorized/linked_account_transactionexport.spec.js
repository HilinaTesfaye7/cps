...
test('test', async ({ page }) => {
  ...
  await page.getByText('View and manage customer').click();
  await page.getByRole('link', { name: 'icon Linked Accounts' }).click();
  await page.getByRole('row', { name: '6377290559621 mikias' }).getByRole('link').click();
  await page.getByRole('button', { name: 'Customer Transactions' }).click();
