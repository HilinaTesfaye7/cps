...
test('test', async ({ page }) => {
  ...
  await page.getByRole('link', { name: 'Product Code Product Code' }).click();
  await page.getByPlaceholder('Search product by name or code').click();
  await page.getByPlaceholder('Search product by name or code').fill('obts');
  await page.getByRole('button', { name: 'Status CB' }).click();
  await page.getByRole('option', { name: 'IFB' }).click();
  await page.getByRole('button', { name: 'Status IFB' }).click();
