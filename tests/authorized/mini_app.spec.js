...
test('test', async ({ page }) => {
  ...
  await page.locator('div').filter({ hasText: /^App Name\*$/ }).locator('span').nth(1).click();
  await page.getByPlaceholder('Enter App Name').fill('ap');
  await page.locator('div').filter({ hasText: /^Mini App Type$/ }).nth(3).click();
  ...
  await page.getByPlaceholder('Enter Product Code').fill('ert');
  await page.getByPlaceholder('Enter VAT Code').click();
  await page.getByPlaceholder('Enter VAT Code').fill('ert');
  await page.getByPlaceholder('Enter Service Fee Code').click();
  await page.getByPlaceholder('Enter Service Fee Code').fill('ert');
