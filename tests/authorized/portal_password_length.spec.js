...
test('test', async ({ page }) => {
  ...
  await page.getByText('Password Reset Date').click();
  await page.getByRole('link', { name: 'Portal Password Length Portal' }).click();
  await page.getByRole('row', { name: '677700955149352 CPS 16 4' }).getByRole('img').click();
