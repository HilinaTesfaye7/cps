...
test('test', async ({ page }) => {
  ...
  await page.getByRole('link', { name: 'Permission Groups Permission' }).click();
  await page.getByRole('row', { name: '67d41bec2af442f6402daff6 Test' }).getByRole('img').click();
  await page.getByRole('row', { name: 'account' }).getByRole('img').first().click();
  await page.getByRole('row', { name: 'account' }).getByRole('img').nth(2).click();
