...
test('test', async ({ page }) => {
  ...
  await page.locator('div:nth-child(21) > .object-contain').click();
await page.locator('.mx-auto > path:nth-child(2)').click();
//upload image
// Ensure the file path is correct
const filePath = 'C:\\Users\\ENVY\\Documents\\cps\\budget.jpg';

// Locate the file input directly (assuming it's an <input type="file">)
const fileInput = await page.locator('input[type="file"]');
await fileInput.setInputFiles(filePath);

console.log('✅ Image uploaded successfully');

// Click 'Add Icon' button after uploading
