...
test('test', async ({ page }) => {
  ...
  await page.getByRole('link', { name: 'Unlink Accounts Unlink' }).click();
  await page.getByRole('button', { name: 'Unlink CIF' }).click();
  await page.getByRole('textbox', { name: 'Search Customer ID or Account' }).click();
  await page.getByRole('textbox', { name: 'Search Customer ID or Account' }).fill('5083004851002');
