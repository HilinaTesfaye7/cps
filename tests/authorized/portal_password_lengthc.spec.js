...
test('test', async ({ page }) => {
  ...
  await page.getByPlaceholder('Screen reader only').click();
  await page.getByPlaceholder('Screen reader only').fill('hhhhhh');
  await page.locator('[id="headlessui-dialog-\\:r6\\:"]').getByRole('button', { name: 'Reject' }).click();
});