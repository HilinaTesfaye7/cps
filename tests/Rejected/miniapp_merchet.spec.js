...
test('test', async ({ page }) => {
  ...
  await page.getByPlaceholder('Enter Merchant Name').click();
  await page.getByPlaceholder('Enter Merchant Name').fill('muzyn');
  await page.getByPlaceholder('Enter Merchant Representative').click();
  await page.getByPlaceholder('Enter Merchant Representative').fill('muzyn');
  await page.getByRole('spinbutton', { name: 'flag +' }).click();
  await page.getByRole('spinbutton', { name: 'flag +' }).fill('934475844');
  await page.getByPlaceholder('Enter Email').click();
  await page.getByPlaceholder('Enter Email').fill('feti@gmail.com');
  await page.locator('[id="headlessui-dialog-\\:r10\\:"] div').filter({ hasText: /^Bank Account$/ }).locator('span').click();
  await page.getByPlaceholder('Enter Bank Account').fill('10008790055');
