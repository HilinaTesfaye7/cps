...
test('test', async ({ page }) => {
  ...
  await page.getByPlaceholder('Search service by name').press('Enter');
  ...
  await page.getByText('Dashen Bank Super App Central Dashboard PortalBbinimMAKERMinimum Transfer').click();
});