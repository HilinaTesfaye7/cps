...
test('test', async ({ page }) => {
  ...
  await page.getByRole('link', { name: 'icon CPS Users' }).click();
  await page.locator('label span').first().click();
  await page.getByPlaceholder('Search by name, phone number').fill('cocoC');
  await page.getByPlaceholder('Search by name, phone number').press('Enter');
